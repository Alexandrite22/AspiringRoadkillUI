    ...
    <Box sx={{ 
        ...
        >
            ...
            >
                ...
                style={{width: "50px"}}
                src={Logo} alt="Logo" />
                <Box sx={{display: "flex", flexDirection: "column", marginLeft: "0.25em"}}>
                    <Typography variant="textNormal" color="textRK">Under{"\n"}Construction</Typography>
                </Box>
            </Box>
            <Link to="/about" className="[&.active]:font-bold">
                <Typography variant="textLarge" color="textRK">About</Typography>
            </Link>
        </Paper>
        <Box
